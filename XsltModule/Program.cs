...
{
	/// <summary>
	/// A simple example demonstrating use of an XPath extension module called from an XSLT stylesheet.
	/// </summary>
	...
	internal class Program
	{
		...
		private static void PerformTransformation(string inputPath, string xsltPath, string outputPath)
		{
            ...
            // Create a module exposing methods from the ExtensionModule class as XPath functions.
		    var module = XdmModule.NativeModule<ExtensionModule>();

            // Make the module's functions available within the transformation.
            xsltSettings.ImportModule(module);
