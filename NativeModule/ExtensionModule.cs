...
namespace XmlPrime.Samples.NativeModule
{
    ...
    public class ExtensionModule
    {
        ...
        public static decimal[] Base64BinaryToOctets([XdmType(XmlTypeCode.Base64Binary, Quantifier.One)] byte[] arg)
        {
            return BinaryToOctents(arg);
        }

        [XdmFunction("base64Binary-to-string")]
        public static string Base64BinaryTostring([XdmType(XmlTypeCode.Base64Binary, Quantifier.One)] byte[] arg, string encoding)
        {
        ...
        [XdmType(XmlTypeCode.Integer, Quantifier.ZeroOrMore)]
        public static decimal[] HexBinaryToOctets([XdmType(XmlTypeCode.Base64Binary, Quantifier.One)] byte[] arg)
        {
            return BinaryToOctents(arg);
        }

        [XdmFunction("hexBinary-to-string")]
        public static string HexBinaryTostring([XdmType(XmlTypeCode.Base64Binary, Quantifier.One)] byte[] arg, string encoding)
        {
            return BinaryToString(arg, encoding);
        }

        [XdmFunction("string-to-hexBinary")]
        [XdmType(XmlTypeCode.HexBinary, Quantifier.One)]
        ...
        [XdmType(XmlTypeCode.Base64Binary, Quantifier.One)]
